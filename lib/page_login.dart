...
import 'package:abseno/helper/app_helper.dart';
import 'package:abseno/page_loginpin.dart';
...
class _PageLogin extends State<PageLogin> {
 ...
 _checkEmail() async {
    ...
    final response = await http.post(applink+"mobile/api_mobile.php?act=cek_emailuser", body: {
    ...
    if(data["message"] != '') {
      ...
      if(data["message"] == '0') {
        showsuccess("Mohon maaf, email tidak ditemukan");
